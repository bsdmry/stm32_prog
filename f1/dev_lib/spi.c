...
void spi_setup(
	...
	if (spi == SPI1){
		rcc_periph_clock_enable(SPI1_A_PORT_RCC);
        	...
        	gpio_set_mode(SPI1_A_PORT, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_ALTFN_PUSHPULL, SPI1_A_SCK | SPI1_A_MOSI | SPI1_A_MISO );
		gpio_set_mode(SPI1_A_PORT, GPIO_MODE_OUTPUT_50_MHZ,  GPIO_CNF_OUTPUT_PUSHPULL, SPI1_A_CS);
		...
		rcc_periph_clock_enable(SPI2_A_PORT_RCC);
        	...
        	gpio_set_mode(SPI2_A_PORT, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_ALTFN_PUSHPULL, SPI2_A_SCK | SPI2_A_MOSI | SPI2_A_MISO );
