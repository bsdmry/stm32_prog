...
#DFUUTIL         := /mnt/nfs/Work/FlashTools/dfu-util
DFUUTIL         = $(shell which dfu-util)
SERIALLOADER	:= /mnt/nfs/Work/PROGRAMMING/Cionizm/stm32_prog/scripts/stm32loader.py
...
%.serial-flash: %.bin
	@printf "  FLASH  $<\n"
	$(SERIALLOADER) -p /dev/ttyUSB0 -w $(*).bin

%.dfu-flash: %.bin
	@printf "  FLASH  $<\n"
	$(DFUUTIL) -d 0483:df11 -a 0 -s 0x08000000 -D $(*).bin
